...
| 当前阶段 | P1：本地路由 |
| 当前 Case | P1-05 |
| 审批状态 | 已批准；P1-04 完成，按 Case 顺序切换至 P1-05 指针 |
| 最后更新时间 | 2026-08-09 02:20 |
...
| P1-05 | 完成 WSL mirrored localhost 主动探测与 WSL projection | P1-03、P1-04 | WSL runner、UNC writer、distro identity、endpoint discovery | 目标 distro 探测 127.0.0.1；不可达/超时/多 distro 差异不写 Live | 删除 takeover intent，恢复 WSL direct；不改系统网络 | in_progress | P1-04 已完成，尚未开始 P1-05；mirrored 成功优先于 NAT |
