...
> 本文件是当前任务的跨机器执行指针，不替代 prd.md、design.md、implement.md 和 research/。P0、P1-01、P1-02 已完成，当前指针为 P1-03。
...
| task.json 状态 | in_progress（P0、P1-01、P1-02 已完成，当前指针为 P1-03） |
| Changelog Target | [TEMP] |
| 当前阶段 | P1：本地路由 |
| 当前 Case | P1-04 |
| 审批状态 | 已批准；P1-03 完成，按 Case 顺序切换至 P1-04 指针 |
| 最后更新时间 | 2026-08-09 02:07 |
...
| P1-04 | 完成 Windows local CLI Home takeover/off/restore | P1-01、P1-03 | provider/home.rs、global.rs、native writer、Windows resolver | Claude/Codex/Grok；最小化、托盘、重启、显式关闭；非 owned 字段保留 | journal compensation 恢复 direct；partial 时 daemon 继续运行 | in_progress | P1-03 已完成，尚未开始 P1-04；要求 active API key 和 ready provider |
