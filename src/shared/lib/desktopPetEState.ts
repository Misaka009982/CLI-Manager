import type { Project, TerminalSession } from "../types/index";
import { shouldIncludeAgentTerminal } from "../../features/agents/api/agentTerminal";
import type { BackgroundPetTask } from "../../features/desktop-pet/api/desktopPet";
import { resolveDesktopPetOpenSessionStatus } from "../../features/desktop-pet/lib/desktopPetStatus";
import type {
  SessionStatus,
