...
} from "../../../shared/lib/desktopPetEState";
import {
  ...
  type InstalledPet,
} from "../../desktop-pet/api/desktopPet";
import { sameBackgroundPetTasks } from "../../desktop-pet/lib/desktopPetTransport";
import { desktopPetESyncFingerprint } from "../../../shared/lib/desktopPetETransport";
...
import { useTerminalStore, type CliHookPayload } from "../store/terminalStore";
import { useDesktopPetERuntimeStore } from "../api/desktopPetERuntimeStore";
import { useDesktopPetEAgentStore } from "../api/desktopPetEAgentStore";
import { findPaneLeafBySession } from "../api/terminalPaneTree";
