...
import type { Project, Group, ProjectFileEntry, ProjectEnvironmentType, WorktreeIsolationStrategy } from "../../../shared/types/index";
import { useSshHostStore } from "../../remote/api/sshHostStore";
import { buildSshConnectionSpec } from "../../remote/api/ssh";
import { DEFAULT_SSH_TOOL_CONFIG_ROOT, resolveSshToolSource, validateSshToolConfigRoot } from "../../remote/api/sshToolIntegration";
...
import { copyTextToClipboard } from "../../../shared/platform/systemClipboard";
import type { OsPlatform } from "../../../shared/platform/shell";
import { getEnabledTerminalShellOptions } from "../../../shared/lib/terminalShellProfiles";
...
import { pickByLanguage, useI18n, type TranslationKey } from "../../../shared/i18n/index";
import { ArrowUp, ChevronRight, FolderOpen } from "lucide-react";
import {
  getCliArgsHistorySuggestions,
  type CliArgsHistoryEntry,
} from "../../../shared/lib/cliArgsHistory";
import { useSshDirectoryBrowser } from "../../remote/api/useSshDirectoryBrowser";
