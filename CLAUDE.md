...
This project is indexed by GitNexus as **CLI-Manager** (20078 symbols, 49237 relationships, 300 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
